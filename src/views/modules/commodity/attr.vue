    ...
    <el-table
      ...
      <el-table-column prop="attrType" header-align="center" align="center" label="属性类型">
        <template slot-scope="scope">
          <span v-if="scope.row.attrType === 0" style="color:#005eff;">销售属性</span>
          <span v-if="scope.row.attrType === 1" style="color:#055a23;">基本属性</span>
          <span v-if="scope.row.attrType === 2" style="color:#ff9900;">混合属性</span>
        </template>
      </el-table-column>
      <el-table-column prop="searchType" header-align="center" align="center" label="参与检索">
        <template slot-scope="scope">
          <el-switch v-model="scope.row.searchType" disabled
      ...
      <el-table-column prop="showDesc" header-align="center" align="center" label="快速展示">
        <template slot-scope="scope">
          <el-switch v-model="scope.row.showDesc" disabled
                     active-color="#13ce66" inactive-color="#ff4949" :inactive-value="0" :active-value="1"></el-switch>
        </template>
      </el-table-column>
      <el-table-column
